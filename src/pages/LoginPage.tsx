...
export function LoginPage() {
    ...
    const handleEmailLogin = async (e: React.FormEvent) => {
        ...
        try {
            // Authentication temporarily disabled - accept any credentials
            // Dummy credentials: demo@example.com / password123
            if (email && password) {
                navigate('/dashboard');
            } else {
            ...
            <div className="w-full max-w-md">
                ...
                <Card>
                    <CardBody className="p-8">
                        ...
                        <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-400 rounded-lg text-sm">

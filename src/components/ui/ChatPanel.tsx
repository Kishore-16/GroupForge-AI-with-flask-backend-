                ...
                {messages.length === 0 ? (
                    ...
                    <>
                        {messages.map((message) => (
                            <div
                                key={message.id}
                                className={`flex gap-3 group ${message.userId === currentUserId ? 'justify-end' : 'justify-start'}`}
                            >
                                ...
                                <div
                                    className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${message.userId === currentUserId
            ...
            <div className="border-t border-gray-100 dark:border-gray-800 p-4 space-y-2">
                <div className="flex gap-2">
                    <textarea
                        ...
                        rows={2}
                        className="flex-1 p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none"
                    />
                    <div className="flex flex-col gap-2">
                        ...
                        <button
                            ...
                            className="p-3 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-lg hover:from-primary-600 hover:to-primary-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                            title="Send message"
                        >
                ...
                <p className="text-xs text-gray-400">💡 Tip: Press Shift+Enter to create a new line</p>
            </div>
        </Card>
    );
}
